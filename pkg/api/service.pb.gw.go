...
func RegisterRankServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RankServiceServer) error {
	...
	mux.Handle("POST", pattern_RankService_AddRank_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/main.RankService/AddRank", runtime.WithHTTPPathPattern("/add-rank"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterRankServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RankServiceClient) error {
	...
	mux.Handle("POST", pattern_RankService_AddRank_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/main.RankService/AddRank", runtime.WithHTTPPathPattern("/add-rank"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_RankService_AddRank_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"add-rank"}, ""))
)
