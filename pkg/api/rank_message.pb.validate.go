...
// Validate checks the field values on OldRank with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *OldRank) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on OldRank with the rules defined in the
// proto definition for this message. If any rules are violated, the result is
// a list of violation errors wrapped in OldRankMultiError, or nil if none found.
func (m *OldRank) ValidateAll() error {
	return m.validate(true)
}

func (m *OldRank) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// OldRankMultiError is an error wrapping multiple validation errors returned
// by OldRank.ValidateAll() if the designated constraints aren't met.
type OldRankMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m OldRankMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m OldRankMultiError) AllErrors() []error { return m }

// OldRankValidationError is the validation error returned by OldRank.Validate
// if the designated constraints aren't met.
type OldRankValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e OldRankValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e OldRankValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e OldRankValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e OldRankValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e OldRankValidationError) ErrorName() string { return "OldRankValidationError" }

// Error satisfies the builtin error interface
func (e OldRankValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = OldRankValidationError{}
...
func (m *OldRanksResp) validate(all bool) error {
	...
	for idx, item := range m.GetOldRanks() {
		_, _ = idx, item
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, OldRanksRespValidationError{
						field:  fmt.Sprintf("OldRanks[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
			...
			if err := v.Validate(); err != nil {
				return OldRanksRespValidationError{
					field:  fmt.Sprintf("OldRanks[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
