...
const (
	RankService_Rank_FullMethodName       = "/main.RankService/Rank"
	RankService_AddPhrases_FullMethodName = "/main.RankService/AddPhrases"
	RankService_AddRank_FullMethodName    = "/main.RankService/AddRank"
	RankService_OldRanks_FullMethodName   = "/main.RankService/OldRanks"
)
...
type RankServiceClient interface {
	Rank(ctx context.Context, in *RankingReq, opts ...grpc.CallOption) (*RankingResp, error)
...
func (c *rankServiceClient) Rank(ctx context.Context, in *RankingReq, opts ...grpc.CallOption) (*RankingResp, error) {
	out := new(RankingResp)
...
func (c *rankServiceClient) AddRank(ctx context.Context, in *AddRankReq, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, RankService_AddRank_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rankServiceClient) OldRanks(ctx context.Context, in *OldRanksReq, opts ...grpc.CallOption) (*OldRanksResp, error) {
	...
	err := c.cc.Invoke(ctx, RankService_OldRanks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RankServiceServer interface {
	Rank(context.Context, *RankingReq) (*RankingResp, error)
...
func (UnimplementedRankServiceServer) Rank(context.Context, *RankingReq) (*RankingResp, error) {
...
func _RankService_Rank_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RankServiceServer).Rank(ctx, req.(*RankingReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RankService_AddRank_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RankService_AddRank_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RankService_OldRanks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RankService_OldRanks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	ProductService_AddProducts_FullMethodName = "/main.ProductService/AddProducts"
)
